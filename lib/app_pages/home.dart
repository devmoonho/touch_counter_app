            ...
            children: <Widget>[
              AnimatedContainer(
                ...
                height: counterProvider.isCounterFill
                    ? (MediaQuery.of(context).size.height - 50) + counterProvider.counterFill.diffPos
                    : MediaQuery.of(context).size.height / 2 + counterProvider.counterFill.diffPos,
                child: CounterWidget(),
              ),
              AnimatedContainer(
                curve: Curves.fastOutSlowIn,
                ...
                // height: (MediaQuery.of(context).size.height - 100) / 2 - counterProvider.counterFill.diffPos,
                height: counterProvider.isCounterFill
                    ? 0.0 - counterProvider.counterFill.diffPos
                    : (MediaQuery.of(context).size.height - 100) / 2 - counterProvider.counterFill.diffPos,
                child: ListWidget(),
              )
            ],
          ),
